...
import com.mathr81.spotifyplus.ModuleContextWrapper;
                            ...
                            generalSettings.setOnClickListener(v -> {
                                ...
                                lastfm.setOnClickListener(button -> {
                                    try {
                                        ...
                                        EditText input = lastfmThing.findViewById(modResources.getIdentifier("last_fm_input", "id", "com.mathr81.spotifyplus"));
                                        Button confirmButton = lastfmThing.findViewById(modResources.getIdentifier("btn_lastfm_confirm", "id", "com.mathr81.spotifyplus"));
                                        Button removeButton = lastfmThing.findViewById(modResources.getIdentifier("btn_lastfm_remove", "id", "com.mathr81.spotifyplus"));
...
//                                userLyrics.setChecked(prefs.getBoolean("lyrics_check_custom", false));
                            ...
                            aboutSettings.setOnClickListener(v -> {
                                ...
                                github.setOnClickListener(button -> {
                                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/Mathr81/SpotifyPlus"));
